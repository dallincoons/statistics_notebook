...
| $x_{i2}$ | `pray == 2` | individual prays once a day |
| $x_{i3}$ | `pray == 3` | individual prays several times a week |
| $x_{i4}$ | `pray == 4` | individual prays once a week |
| $x_{i5}$ | `pray == 5` | individual prays less than once a week |
| $x_{i6}$ | `pray == 6` | individual never prays |
